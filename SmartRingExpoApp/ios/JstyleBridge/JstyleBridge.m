...
- (void)ConnectSuccessfully {
    ...
    // NOTE: do NOT call enableAutomaticHRMonitoring here — services aren't discovered yet.
    // ConnectSuccessfully fires from didConnectPeripheral, before didDiscoverCharacteristicsForService.
    // Use EnableCommunicate below instead.
}

// Called after service+characteristic discovery completes (didDiscoverCharacteristicsForService → enable)
