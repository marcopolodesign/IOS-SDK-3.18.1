    ...
    <View style={styles.container}>
      ...
      <View style={styles.gradientZone}>
        <Svg style={StyleSheet.absoluteFill} viewBox="0 0 100 100" preserveAspectRatio="xMidYMid slice">
          <Defs>
            <RadialGradient id="tempGrad" cx="51%" cy="-86%" rx="80%" ry="300%">
              <Stop offset="0%" stopColor="#FF8C42" stopOpacity={0.85} />
              <Stop offset="55%" stopColor="#FF8C42" stopOpacity={0} />
            </RadialGradient>
            <RadialGradient id="tempGrad2" cx="85%" cy="15%" rx="45%" ry="60%">
              <Stop offset="0%" stopColor="#C25A1A" stopOpacity={0.55} />
