...
-(void)BleCommunicateWithPeripheral:(CBPeripheral*)Peripheral data:(NSData *)data
{
    ...
    if(deviceData.dataType == AutomaticSpo2Data_X3)
    {
        ...
        {
            // 继续读取剩下的数据
            NSData * data = [[BleSDK_X3 sharedManager] GetAutomaticSpo2DataWithMode:2 withStartDate:nil];
...
- (IBAction)getData:(UIButton *)sender {
    ...
    if([[NewBle sharedManager] isConnectOrConnecting]==YES){
            ...
            strText = @"";
        NSData * data = [[BleSDK_X3 sharedManager] GetAutomaticSpo2DataWithMode:0 withStartDate:nil];
...
- (IBAction)deleteData:(UIButton *)sender {
    if([[NewBle sharedManager] isConnectOrConnecting]==YES){
        ...
        strText = @"";
        NSData * data = [[BleSDK_X3 sharedManager] GetAutomaticSpo2DataWithMode:0x99 withStartDate:nil];
